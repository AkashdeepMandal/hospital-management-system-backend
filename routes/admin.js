...
router.get("/api/reports/getAge", (req, res, next) => {
  Patient.aggregate([
    ...
    let group6 = 0;
    let array = [
      2017, 2017, 2012, 2012, 2002, 2002, 2002, 1995, 1995, 1995, 1995, 1975,
      1975, 1975, 1975, 1975, 1960, 1960, 1960, 1960, 1960, 1960,
    ];
    response.forEach((r) => {
...
router.get("/api/doctor/getDoctorName/:regNo", (req, res, next) => {
  console.log(
    "This is getting doctor name  - Adding doctor as a system user/For Sidemenu"
  );
  Doctor.findOne(
    { doctorRegistrationNumber: req.params.regNo },
...
router.get("/api/employee/generateRegistrationNumber", (req, res, next) => {
  ...
  Employee.find(null, "employeeRegistrationNumber")
    .sort("-employeeRegistrationNumber")
    .limit(1)
    .then((result) => {
      console.log(result);
...
router.get(
  "/api/admin/reports/getAppointmentsByYear/:year",
  (req, res, next) => {
...
router.get(
  "/api/admin/reports/getAppointmentsByDoctor/:year&:doctor",
  (req, res, next) => {
